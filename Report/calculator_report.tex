...
\begin{document}
	...
	\section{Method}
			...
			I also use the \href{http://www.stroustrup.com/C++11FAQ.html}{C++11 language standards}.
		% End of subsection 1
	...
	\section{Result}
		...
		\begin{itemize}
			...
			\item Some issues with multiple bracket pairs after each other ["1+(2+(3+4))" is fine, "1+(2+3)+(4+5)" is problematic].
		\end{itemize}
	...
	*what the result means for the future or whatever Idk*
	...
	I also changed my plans from the project plan/sketch massively for partly the same reason. \cite{CGD_ProjPlanRep2016} %!!!!!!
